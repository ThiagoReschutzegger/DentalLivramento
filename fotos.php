...
<!-- ________________________Latest Cars Image Thumbnail________________-->
	<div class="grid">
		<div class="row">
                    <?php $count = 1; ?>
                    <?php foreach ($data['imagem'] as $img): ?>
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="txthover">
					<img src="<?php echo $this->base_url ?>view/images/<?php echo $img->getSrc() ?>" alt="car<?php echo $count; ?>">
						<div class="txtcontent">
							...
							<div class="simpletxt">
								<h3 class="name"><?php echo $img->getTitle() ?></h3>
								<p><?php echo $img->getDescricao() ?></p>
                                                                <br>
                                                                <br>
							</div>
							<div class="stars2">
