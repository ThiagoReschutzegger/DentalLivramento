...
class ProdutoModel extends Model {
    ...
    public function getProduto() {
        ...
        foreach ($consulta as $linha) {
            $list[] = new Produto($linha['id_produto'],$linha['barcode'],$linha['preco'],$linha['nome'],
                                  $linha['estoque'],$linha['imagem'],$linha['descricao'],$linha['destaque'],
                                  $linha['tipo'],$linha['id_grupo'],$linha['id_marca']);
        }
        return $list;
    }
    ...
    public function getProdutoById($id) {
        ...
        $produto = $this->ExecuteQuery($sql, [':id' => $id])[0];
            return new Produto($produto['id_produto'],$produto['barcode'],$produto['preco'],$produto['nome'],
                                  $produto['estoque'],$produto['imagem'],$produto['descricao'],$produto['destaque'],
                                  $produto['tipo'],$produto['id_grupo'],$produto['id_marca']);
    }
