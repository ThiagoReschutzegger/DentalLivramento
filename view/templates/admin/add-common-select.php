...
<div class="card-header d-flex align-items-center">
  <h3 class="h4">Selecine o Grupo em que o produto se encontra:</h3>
</div>
                ...
                <tbody>
                    ...
                    <?php foreach ($data['grupo'] as $grupo):
                      if ($grupo->getId_categoria() == $categoria->getId_categoria()){
                          ...
                          <td>'.$grupo->getNome().'</td>
                          <td>
                          <a class="btn btn-success" style="font-size: 10px;" href="'.$this->base_url.'ProdutoAdmin/addCommonProd/'.$grupo->getId_grupo().'"><i class="fa fa-check"></i></a>
                          </td>
                          </tr>';
                          $algum = true;
                      }
