    ...
    <div class="card-body">
      <form class="form-horizontal" method="post">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <textarea class="form-control" name="descricao">A categoria não possui descrição.</textarea>
          </div>
        </div>
        <div class="line"></div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <input type="submit" class="btn btn-success col-sm-4 " value="Salvar" name="add" />
            <a href="<?php echo $this->base_url; ?>CategoriaAdmin" class="btn btn-danger col-sm-8 offset-sm-2" style="margin-top: 10px;">Parar de Adicionar<a/>
        </div>
      </form>
    </div>
  </div>
