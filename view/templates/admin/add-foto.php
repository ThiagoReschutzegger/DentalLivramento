    ...
    <div class="card-body">
      <form class="form-horizontal" method="post" enctype="multipart/form-data">
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input class="form-control" type="file" name="foto" accept="image/*" style="height: 45px"><small class="help-block-none">Arquivos .jpg, .png, .jpeg e .gif.</small>
          </div>
        </div>
        <div class="form-group row">
