          ...
          <div class="col-sm-8">
            <select class="form-control" name="id_categoria">
              ...
              <?php foreach( $data['categoria'] as $categoria ): ?>
                  <option value="<?php echo $categoria->getId_categoria(); ?>" <?php if($grupo->getId_categoria() == $categoria->getId_categoria()){echo 'selected="selected"';} ?> ><?php echo $categoria->getNome(); ?></option>
              <?php endforeach; ?>
            </select>
          </div>
        </div>
