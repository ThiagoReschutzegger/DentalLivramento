      ...
      <nav class="navbar navbar-main navbar-default navbar-expand-md nav-V3" role="navigation">
        <div class="container">
          ...
          <div class="nav-category dropdown">
            <a href='#menu' class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
            <center>Categorias
              <button type="button">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
              <li class="dropdown nav-item active">
                <a href="<?php echo $this->base_url ?>Home" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Home</a>
              </li>
