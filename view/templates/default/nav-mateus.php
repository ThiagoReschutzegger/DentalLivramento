      ...
      <div class="header clearfix headerV3">
        ...
        <div class="navTop text-center">
          <div class="container">
              ...
              <center><img class="logo-pl logo-nav image-fluid" src="<?php echo $this->asset ?>img/DentalLivramentoLogoFinal.png" style="max-height:70px"></center>
            ...
            <div class="navTop-middle">
              ...
              <div class="searchBox">
                <span class="input-group">
                  <input id="searchbox" type="text" class="form-control" placeholder="Search Items…" aria-describedby="basic-addon2">
        ...
        <nav class="navbar navbar-main navbar-default navbar-expand-md nav-V3" role="navigation">
          <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
              ...
              <div id='cssmenu'>
                <ul>
                   <li><a href="javascript:void(0)" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Home</a></li>
                   <li class='active'><a href="javascript:void(0)" class="nav-link dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="300" data-close-others="true" aria-expanded="false">Categoria</a>
              ...
              <p></p>
                 ...
                 <li class='active'><a href="javascript:void(0)" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Shop</a>
               <ul>
                 <li><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href='#'>Products Grid View</a>
                      <ul class="dropdown-menu">
                 ...
                 <li><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href='#'>Products List View</a>
                      <ul class="dropdown-menu">
                   ...
                   <li><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href='#'>Checkout</a>
                      <ul class="dropdown-menu">
