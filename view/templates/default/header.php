...
<html lang="en">
  <head>
    ...
    <link href="<?php echo $this->asset ?>plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?php echo $this->asset ?>plugins/selectbox/select_option1.css" rel="stylesheet">
        ...
        <nav class="navbar navbar-main navbar-default navbar-expand-md" role="navigation">
          <div class="container">
            ...
            <a class="navbar-brand" href="<?php echo $this->base_url ?>Home">
              <center><img class="logo-pl image-fluid" src="<?php echo $this->asset ?>img/DentalLivramentoLogoFinal.png" style="max-height:70px"></center>
